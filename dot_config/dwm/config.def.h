...
static const char *fonts[]          = { "TerminessNerdFont:size=16" };
...
static const unsigned int baralpha = 0xfd;
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg, col_bg, col_bg },
	[SchemeSel]  = { col_fg, col_bg,  col_fg  },
	[SchemeStatus]  = { col_lightblue, col_bg,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_bg, col_fg,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { col_lightblue, col_bg,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
